...
import com.example.user.timertutorial.R.id.left

class board_notice : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btn_notice_sh = findViewById<Button>(R.id.btn_notice_sh)

        btn_notice_sh.setOnClickListener {
            var nextIntent = Intent(this, sh_notice1::class.java)
        ...
        while (c.moveToNext()) {
            ...
            if(txt_show_cate == "공지") {
                ...
                button.layoutParams.height = WRAP_CONTENT
                button.layoutParams.width = MATCH_PARENT
                ...
                button.setOnClickListener {
                    var nextIntent = Intent(this, detail_text::class.java)
